...
class CardControllerWidget extends StatelessWidget {
  ...
  double getCardHeight(int index) {
    ...
    if (diff >= 0.0 && diff < 1.0) {
      ...
      return (cardMaxHeight - cardMaxHeight * (4 / 5) * ((diff - diff.floor()))) - 15;
    } else if (diff >= 1.0 && diff < 2.0) {
      print('cardPager : ${index} - 1');
      return cardMaxHeight - cardMaxHeight * (4 / 5) - 10 * ((diff - diff.floor())) + 15;
    } else {
      print('cardPager : ${index} - 2');
      final height = cardMaxHeight - cardMaxHeight * (4 / 5) - 10 - 5 * ((diff - diff.floor())) + 5;
